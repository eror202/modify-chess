...
public class Pawn extends Piece {
    ...
    public Pawn(COLOUR colour, Coordinate OGcoord) {
        ...
        if (getColour() == COLOUR.B) {
            readBufferedImage("images/BPawn.png");
            icon = new ImageIcon("images/BPawn.png");
        }
        else if (getColour() == COLOUR.W) {
            readBufferedImage("images/WPawn.png");
    ...
    //________________________________________________Special org.smirnov.domains.Pawn org.smirnov.moveLogic.Move Methods________________________________________________
     ...
     * @return a org.smirnov.domains.Piece (out of org.smirnov.domains.Queen, org.smirnov.domains.Rook, org.smirnov.domains.Bishop or org.smirnov.domains.Knight), based on the user input.
    ...
    public Piece promotionQuery(Coordinate promotionSquare) {
        ...
        while (!correctInput) {
            System.out.println("You can choose between: \n" +
                    "· org.smirnov.domains.Queen (Q) \n" +
                    "· org.smirnov.domains.Rook (R) \n" +
                    "· org.smirnov.domains.Bishop (B) \n" +
                    "· org.smirnov.domains.Knight (N) \n" +
                    "· org.smirnov.domains.Joker (J)");
            String promoted = sc.next();
            switch (promoted) {
                case "org.smirnov.domains.Queen":
                case "Q":
                    promotee = new Queen(getColour(), promotionSquare);
                    correctInput = true;
                    break;
                case "org.smirnov.domains.Rook":
                case "R":
                    promotee = new Rook(getColour(), promotionSquare);
                    correctInput = true;
                    break;
                case "org.smirnov.domains.Bishop":
                case "B":
                    promotee = new Bishop(getColour(), promotionSquare);
                    correctInput = true;
                    break;
                case "org.smirnov.domains.Knight":
                case "N":
                    promotee = new Knight(getColour(), promotionSquare);
                    correctInput = true;
                    break;
                case "org.smirnov.domains.Joker":
                case "J":
                    promotee = new Joker(getColour(), promotionSquare);
                    correctInput = true;
                default:
    ...
    /**
     * The promotion query for a org.smirnov.boardLogic.GUIBoard to determine what the pawn will be promoted to.
    ...
    public void GUIPromotionQuery (Coordinate promotionSquare) {
        ...
        if (this.getColour() == COLOUR.B) {
            queenOption = new JButton(readBufferedImage("images/BQueen.png"));
            rookOption = new JButton(readBufferedImage("images/BRook.png"));
            bishopOption = new JButton(readBufferedImage("images/BBishop.png"));
            knightOption = new JButton(readBufferedImage("images/BKnight.png"));
            jokerOption = new JButton(readBufferedImage("images/BJoker.png"));
            promotedPiece = new Queen(COLOUR.B,promotionSquare);
            icon = readBufferedImage("images/BPawn.png");
        }
        else {
            queenOption = new JButton(readBufferedImage("images/WQueen.png"));
            rookOption = new JButton(readBufferedImage("images/WRook.png"));
            bishopOption = new JButton(readBufferedImage("images/WBishop.png"));
            knightOption = new JButton(readBufferedImage("images/WKnight.png"));
            jokerOption = new JButton(readBufferedImage("images/WJoker.png"));
            promotedPiece = new Queen(COLOUR.W,promotionSquare);
            icon = readBufferedImage("images/WPawn.png");
        }
        ...
        GUIBoard.formatInvisibleButton(jokerOption);

        Object[] options = {"OK",knightOption,bishopOption,rookOption,queenOption, jokerOption};
        ...
        jokerOption.addActionListener(actionEvent -> promotedPiece = new Joker(getColour(),promotionSquare));
    ...
    /**
     * Produces an ArrayList containing all the raw moves available to a org.smirnov.domains.Pawn within a given board
     * @param pieces the board being played in
     * @return an ArrayList containing all the coordinates available to a org.smirnov.domains.Pawn, based on:
    ...
    private ImageIcon readBufferedImage (String imagePath) {
        try {
            InputStream is = Pawn.class.getClassLoader().getResourceAsStream(imagePath);
